...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		feathercoreignitemodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	FeathercoreigniteKeeper feathercoreignitemodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		feathercoreignitemoduletypes.StoreKey,
	...
	*/
	...
	app.FeathercoreigniteKeeper = *feathercoreignitemodulekeeper.NewKeeper(
		appCodec,
		keys[feathercoreignitemoduletypes.StoreKey],
		keys[feathercoreignitemoduletypes.MemStoreKey],
		app.GetSubspace(feathercoreignitemoduletypes.ModuleName),
	)
	feathercoreigniteModule := feathercoreignitemodule.NewAppModule(appCodec, app.FeathercoreigniteKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		feathercoreignitemoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(feathercoreignitemoduletypes.ModuleName)
